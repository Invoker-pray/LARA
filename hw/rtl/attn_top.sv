module attn_top
  import attn_pkg::*;
( clk, rst_n, s_axi_awaddr, s_axi_awvalid, s_axi_awready, s_axi_wdata, s_axi_wstrb, s_axi_wvalid, s_axi_wready, s_axi_bresp, s_axi_bvalid, s_axi_bready, s_axi_araddr, s_axi_arvalid, s_axi_arready, s_axi_rdata, s_axi_rresp, s_axi_rvalid, s_axi_rready, s_axis_tdata, s_axis_tvalid, s_axis_tready, s_axis_tlast, m_axis_tdata, m_axis_tvalid, m_axis_tready, m_axis_tlast, irq );
  ...
  // Cycles the controller spends with a K/V fill request outstanding; the
  // K/V share of stall_cycles, split out for transport A/B analysis.
  ...
  always_ff @(posedge clk or negedge rst_n) begin
    if (!rst_n)
      kv_transport_stall_cycles <= 32'd0;
    else if (start)
      kv_transport_stall_cycles <= 32'd0;
    else if (kv_load_req_pending && !kv_load_done)
      kv_transport_stall_cycles <= kv_transport_stall_cycles + 32'd1;
  end
