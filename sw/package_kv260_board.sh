...
required=(
  ...
  "$ROOT_DIR/board_cases_rtl_contract_v2.6_fixed"
  "$ROOT_DIR/board_cases_rtl_contract_v2.6_q31_kv7"
...
cp -a "$ROOT_DIR/board_cases_rtl_contract_v2.6_fixed" "$OUTPUT_DIR/"
cp -a "$ROOT_DIR/board_cases_rtl_contract_v2.6_q31_kv7" "$OUTPUT_DIR/"
...
echo "Verify after copying: cd <target>/lara && sha256sum -c LARA_SHA256SUMS"
